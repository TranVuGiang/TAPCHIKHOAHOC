        ...
        <div className="min-h-screen flex items-center justify-center bg-red-950 font-montserrat">
            <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  ${errors.email ? 'border-red-500' : 'border-red-800'}`}
                                required
                            />
                        </div>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-red-800 hover:bg-emerald-900 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 ease-in-out transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
