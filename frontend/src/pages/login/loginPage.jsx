        ...
        <section className="min-h-screen bg-red-950 flex items-center justify-center font-montserrat">
            <div className="bg-gray-100 flex justify-center rounded-2xl shadow-lg max-w-3xl w-full p-5">
                <div className="md:w-1/2 px-10 pt-7">
                    <h2 className="font-bold text-2xl text-red-700 text-center">Đăng nhập</h2>
                    <p className="text-sm mt-4 text-green-800 text-center">Nếu đã có tài khoản, hãy đăng nhập</p>
            ...
            ${errors.password ? 'border-red-500' : ''}`}
                        ...
                        <button
                            type="submit"
                            className="bg-red-800 rounded-lg text-white py-2 
                                hover:bg-emerald-700 transition duration-300 disabled:opacity-50"
                            disabled={isLoading}
                        >
                    ...
                    <div className="mt-3 text-xs flex justify-between items-center">
                        ...
                        <button
                            ...
                            className="py-2 px-5 bg-red-950 text-amber-50 border rounded-xl 
                ...
                <div className="md:block hidden w-1/2">
                    <img src={loginGIF} alt="LoginImage" className="rounded-2xl" />
                </div>
            </div>
        </section>
    );
