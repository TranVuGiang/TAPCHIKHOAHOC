...
function MagazineCard({ weekNumber, issueNumber, publicationDate, title, excerpt, coverImage }) {
    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 h-[500px]">
            ...
            <div className="px-6 py-4">
                ...
                <button
                    ...
                    className="group flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition-colors duration-300"
                >
                    Đọc thêm
