...
export const BaiVietDaThich = () => {
    ...
    const loadBaiBaoDaThich = async () => {
        ...
        try {
            setIsLoading(true);
            const resp = await authService.baibaoDathich(current.token);
            ...
            {baibaos.map((item) => (
                ...
                >
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Ngày: {item.thoigian.split(' ')[1]}/2024</p>
                    </div>
